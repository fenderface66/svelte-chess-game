...
var app = (function () {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (rank === undefined && !('rank' in $$props || $$self.$$.bound[$$self.$$.props['rank']])) {
    			console_1$2.warn("<Square> was created without expected prop 'rank'");
    		}

    		if (file === undefined && !('file' in $$props || $$self.$$.bound[$$self.$$.props['file']])) {
    			console_1$2.warn("<Square> was created without expected prop 'file'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<Square> was created with unknown prop '${key}'`);
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Piece> was created with unknown prop '${key}'`);
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const startGame = () => {
    		Object.keys(gameState).map(key => {
    			...
    			const startingSquareNode = document.querySelector(`#${pieceData.startingPosition}`);
