    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file_1, 11, 0, 248);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (rank === undefined && !('rank' in $$props || $$self.$$.bound[$$self.$$.props['rank']])) {
    			console.warn("<Square> was created without expected prop 'rank'");
    		}

    		if (file === undefined && !('file' in $$props || $$self.$$.bound[$$self.$$.props['file']])) {
    			console.warn("<Square> was created without expected prop 'file'");
    		}
    	});
    	...
    	$$self.$capture_state = () => ({ rank, file, backgroundColour });
    	...
    	return [rank, file, backgroundColour];
    }
