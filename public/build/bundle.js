...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file_1, 34, 0, 736);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const handleDragDrop = e => {
    		...
    		game.update(n => ({
    			...n,
    			"test-piece": { id: "test-piece", position: squareId }
    		}));
    	...
    	$$self.$$.on_mount.push(function () {
    		if (rank === undefined && !('rank' in $$props || $$self.$$.bound[$$self.$$.props['rank']])) {
    			console_1$1.warn("<Square> was created without expected prop 'rank'");
    		}

    		if (file === undefined && !('file' in $$props || $$self.$$.bound[$$self.$$.props['file']])) {
    			console_1$1.warn("<Square> was created without expected prop 'file'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Square> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "test-piece");
    			attr_dev(div, "data-testid", "test-piece");
    			attr_dev(div, "draggable", "true");
    			attr_dev(div, "class", "test-piece svelte-ye3sa8");
    			add_location(div, file$1, 4, 0, 53);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "drag", /*onDragPiece*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onDragPiece });
    	return [onDragPiece];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 28, 0, 891);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t);
    			mount_component(piece_1, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const unsubscribe = game.subscribe(value => {
    		...
    		const newPosition = document.querySelector(`#${gameState["test-piece"].position}`);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('piece' in $$props) piece = $$props.piece;
